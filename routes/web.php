...
Route::group(['middleware' => 'disable_back_btn'], function () {
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::post('/katalog/import', [SetupController::class, 'importKatalog'])->name('setup.importkatalog');
        ...
        Route::put('/activities/standart_part/update-all', [ActivitiesController::class, 'updateAllStandartPart'])->name('activities.update_all_standart_part');
                ...
                Route::get('/activities/used_time/edit/{id}', [ActivitiesController::class, 'editusedtime'])->name('activities.editusedtime');
                Route::put('/activities/used_time/update/{id}', [ActivitiesController::class, 'updateusedtime'])->name('activities.updateusedtime');
        ...
        Route::get('report/order/view/{order_number}', [ReportController::class, 'viewOrder']);
        //report-controlsheet
