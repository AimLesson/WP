    ...
    <div class="content-wrapper" style="background-color: rgb(255, 255, 255);">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">View Sales Order</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <div class="container print-only" style="background-color: rgb(255, 255, 255);margin-bottom:30px;">
            <div class="col-md-12" style="text-align: center;">
                <h4 style="margin-top:7px;">SALES ORDER</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 m-b-20 no-print">
                                        ...
                                        <ul class="list-unstyled">
                                            <li>{{ $salesorderJoin[0]->company_name }}</li>
                                            <li>{{ $salesorderJoin[0]->address }}</li>
                                            <li>{{ $salesorderJoin[0]->tax_address }}</li>
                                            <li class="tax">{{ $salesorderJoin[0]->tax }}</li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-6 m-b-20 no-print">
                                        <div class="invoice-details">
                                            <h3 class="text-uppercase">Sales Order #{{ $salesorderJoin[0]->so_number }}
                                            </h3>
                                            <ul class="list-unstyled">
                                                <li>Create Date:
                                                    <span>{{ date('d F, Y', strtotime($salesorderJoin[0]->date)) }}</span>
                                                </li>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-lg-12 m-b-20 no-print">
                                        <h5>Estimate to: {{ $salesorderJoin[0]->name }}</h5>
                                        <ul class="list-unstyled">
                                            <li><a href="#">{{ $salesorderJoin[0]->phone }}</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <h5 class="print-only" style="text-align: right; font-weight:bold;">{{ $salesorderJoin[0]->so_number }}</h5>
                                ...
                                <div>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="text-right subtotal">
                                                                    {{ $salesorderJoin[0]->subtotal }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th>Discount: <span
                                                                        class="text-regular">{{ $salesorderJoin[0]->discount_percent }}%</span>
                                                                </th>
                                                                <td class="text-right discount">
                                                                    {{ $salesorderJoin[0]->discount }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th>Tax: <span
                                                                        class="text-regular">{{ $salesorderJoin[0]->tax_type }}</span>
                                                                </th>
                                                                <td class="text-right tax">{{ $salesorderJoin[0]->tax }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th>Freight:</th>
                                                                <td class="text-right freight">
                                                                    {{ $salesorderJoin[0]->freight }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th>Total Amount:</th>
                                                                <td class="text-right text-primary">
                                                                    <h5 class="totalamount">
                                                                        {{ $salesorderJoin[0]->total_amount }}</h5>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                    ...
                                    <div class="invoice-info">
                                        <h5>Description</h5>
                                        <p class="text-muted">{{ $salesorderJoin[0]->description }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
