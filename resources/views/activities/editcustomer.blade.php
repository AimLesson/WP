...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ route('activities.updatecustomer', ['id' => $customer->id]) }}" method="POST"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="customer_no" class="form-control"
                                                    id="exampleInputCompany" placeholder="Insert Customer No"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="company" class="form-control"
                                                    id="exampleInputCompany" placeholder="Insert Company"
                                                    oninput="this.value = this.value.toUpperCase()" required
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="city" class="form-control"
                                                    id="exampleInputCity" placeholder="Insert City"
                                                    oninput="capitalizeName(this)" required
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="province" class="form-control"
                                                    id="exampleInputCity" placeholder="Insert Province"
                                                    value="{{ old('province', $customer->province) }}" oninput="capitalizeCity(this)">
                                                @error('province')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="zipcode" class="form-control"
                                                    id="exampleInputCity" placeholder="Insert Zip Code"
                                                    value="{{ old('zipcode', $customer->zipcode) }}" oninput="capitalizeCity(this)">
                                                @error('zipcode')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="country" class="form-control"
                                                    id="exampleInputCity" placeholder="Insert country"
                                                    value="{{ old('country', $customer->country) }}" oninput="capitalizeCity(this)">
                                                @error('country')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone" class="form-control"
                                                    id="exampleInputPhone" placeholder="Insert Phone" required
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="fax" class="form-control"
                                                    id="exampleInputFax" placeholder="Insert Fax" required
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="npwp" class="form-control"
                                                    id="exampleInputNPWP" placeholder="__.___.___._-___.___"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="shipment" class="form-control" id="exampleInputShipment" placeholder="Insert Shipment"
                                                    oninput="capitalizeName(this)">{{ old('shipment', $customer->shipment) }}</textarea>
                                                @error('shipment')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="cp" class="form-control"
                                                    id="exampleInputCity" placeholder="Insert Contact Person"
                                                    value="{{ old('cp', $customer->cp)}}" oninput="capitalizeCity(this)">
                                                @error('cp')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="webpage" class="form-control"
                                                    id="exampleInputCity" placeholder="Insert webpage"
                                                    value="{{ old('webpage', $customer->webpage) }}" oninput="capitalizeCity(this)">
                                                @error('webpage')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
