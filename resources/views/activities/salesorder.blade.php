                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="salesorder" class="table table-head-fixed text-nowrap">
                                    <thead>
                                        <tr>
                                            <th>SO No.</th>
                                            <th>PO No.</th>
                                    ...
                                    <tbody>
                                        @foreach ($salesorder as $so)
                                            <tr>
                                                <td hidden class="idso">{{ $so->id }}</td>
                                                <td hidden class="so_number">{{ $so->so_number }}</td>
                                                <td><a
                                                        href="{{ url('activities/salesorder/view/' . $so->so_number) }}">{{ $so->so_number }}</a>
                                                </td>
                                                <td>{{ $so->po_number }}</td>
