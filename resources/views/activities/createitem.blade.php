    ...
    $(document).ready(function() {
        ...
        function filterNamaBarang(row) {
            ...
            materialDropdown.find('option').each(function() {
                ...
                if (kodeLogMaterial === selectedKodeLog || !selectedKodeLog || selectedKodeLog === 'Rangkaian') {
                    $(this).show(); // Show if it matches or if no kode_log is selected or is "Rangkaian"
        ...
        $(document).on('change', '.kodelog', function() {
            ...
            calculateMaterialCost(row); // Ensure cost is recalculated when kode_log changes
        });
        ...
        function calculateMaterialCost(row) {
            ...
            if (kodeLog === 'Rangkaian' || material === 'Rangkaian') {
                console.log('Rangkaian selected, setting material cost to 0');
                materialCost = 0;
            } else {
        ...
        $('#addBtn').click(function() {
            ...
            const newRow = `
            <tr>
                <!-- New row HTML structure remains the same -->
            </tr>`;
