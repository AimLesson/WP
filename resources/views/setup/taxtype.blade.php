    ...
    <div class="content-wrapper">
       ...
       <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <a href="{{ route('setup.createtaxtype') }}" class="btn btn-primary mb-3"><i class="fas fa-plus"></i>
                        Add</a>
                    <div class="card">
                                ...
                                <tbody>
                                    @foreach ($taxtype as $t)
                                        <tr>
                                            ...
                                            <td>{{$t->tax}}</td>
                                            <td>
                                                <a href="{{ route('setup.edittaxtype', ['id' => $t->id]) }}"
                                                    class="btn-xs btn-warning"><i class="fas fa-pen"></i>
                                                    Edit</a>
                                                <a href="" data-toggle="modal"
                                                    data-target="#modal-hapus{{ $t->id }}"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Confirm Delete Task Type</h4>
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                        <form action="{{ route('setup.deletetaxtype', ['id' => $t->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
