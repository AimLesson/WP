...
@section('content')
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Add SO Target</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ route('setup.storesotarget') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="col-md-6">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Add SO Target Form</h3>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="product_type" class="form-control" id="product_type" required>
                                            ...
                                            <option value="WF Standart Produk">WF Standart Produk</option>
                                            <option value="WF Customized Produk">WF Customized Produk</option>
                                        </select>
                                        @error('product_type')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="total_order" class="form-control" id="total_order"
                                            placeholder="Insert Total Order" required>
                                        @error('total_order')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nominal_value" class="form-control" id="nominal_value"
                                            placeholder="Insert Nominal Value" required>
                                        @error('nominal_value')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
    ...
    <script>
        ...
        var soinput = document.getElementById('total_order', 'nominal_value');
