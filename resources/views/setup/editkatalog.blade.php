...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ route('setup.updatekatalog', ['id' => $no_katalog->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_katalog" value="{{$no_katalog->no_katalog}}" class="form-control" id="exampleInputName"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_katalog" value="{{$no_katalog->nama_katalog}}" class="form-control" id="exampleInputUsername"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="price" value="{{$no_katalog->price}}" class="form-control" id="exampleInputPrice"
