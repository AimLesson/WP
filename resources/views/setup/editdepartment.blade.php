    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="containerfluid-">
                <form action="{{ route('setup.updatedepartment', ['id' => $department->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kode" class="form-control" id="exampleInputName"
                                            placeholder="Insert Kode" value="{{ $department->kode }}" readonly required>
                                        @error('kode')
                                            <small>{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="work_unit" id="work_unit"
                                            style="width: 100%;">
                                            <option selected="selected" required disabled>-- Select a Work Unit --
                                            </option>
                                            @php
                                            ...
                                            @foreach ($work_unit as $wu)
                                                <option value="{{ $wu->work_unit }}"
                                                    @if ($wu->work_unit == $department->work_unit) selected @endif>
                                                    {{ $wu->work_unit }} - {{ $wu->information }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('work_unit')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="exampleInputUsername"
                                            placeholder="Insert Name" value="{{ $department->name }}" required>
                                        @error('name')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" class="form-control" id="exampleInputUsername"
                                            placeholder="Insert Email" value="{{ $department->email }}" >
                                        @error('email')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="group" class="form-control" id="group"
                                            ...
                                            value="{{ $department->group }}" readonly required>
                                        @error('group')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="user_novvel" class="form-control"
                                            id="exampleInputUsername" placeholder="Insert User Novvel"
                                            value="{{ $department->user_novvel }}" required>
                                        @error('user_novvel')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="information" class="form-control" id="information"
                                            ...
                                            value="{{ $department->information }}" readonly required>
                                        @error('information')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="nik" class="form-control" id="exampleInputUsername"
                                            placeholder="Insert NIK" value="{{ $department->nik }}" >
                                        @error('nik')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
            ...
            $('#work_unit').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#group').prop('value', response.group);
                        $('#information').prop('value', response.information);
                    },
                    error: function(error) {
                        console.error(error);
                        ('Terjadi kesalahan dalam mengambil data Work Unit.');
                    }
                });
            });
        });
