    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <a href="{{ route('setup.createsalesman') }}" class="btn btn-primary mb-3"><i
                                class="fas fa-plus"></i>
                            Add</a>
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Salesman Data</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="machine" class="table table-head-fixed text-nowrap">
                                    ...
                                    <tbody>
                                        @foreach ($salesman as $m)
                                            <tr>
                                                <td>{{$loop->iteration}}</td>
                                                <td>{{ $m->salesman }}</td>
                                                <td>{{ $m->unit }}</td>
                                                <td>
                                                    <a href="{{ route('setup.editsalesman', ['id' => $m->id]) }}"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Are you sure delete
                                                                <b>{{ $m->salesman }} - {{ $m->salesman }} ?</b>
                                                            </p>
                                                        </div>
                                                        <div class="modal-footer justify-content-between">
                                                            <form
                                                                action="{{ route('setup.deletesalesman', ['id' => $m->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
