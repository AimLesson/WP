                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('setup') }}">Home</a></li>
        ...
        <section class="content">
            <div class="containerfluid-">
                ...
                @foreach ($company_info as $ci)
                    <a href="{{ route('setup.editcompanyinfo', ['id' => $ci->id]) }}" class="btn btn-warning mb-3"><i
                            class="fas fa-pen"></i>
                        Edit</a>
                    {{-- Content 1 --}}
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="company_name" class="form-control" id="company_name"
                                            placeholder="Insert Company Name" value="{{ $ci->company_name }}" readonly
                                            required>
                                        @error('company_name')
                                            <small>{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="machine_type" class="form-control" id="machine_type"
                                            placeholder="Insert Machine Type" value="{{ $ci->machines_type }}" readonly
                                            required>
                                        @error('machine_type')
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="port" class="form-control" id="port"
                            placeholder="Insert Cort" value="587" readonly required>
                        @error('port')
                            <small>{{ $message }}</small>
                        @enderror
                    </div>
