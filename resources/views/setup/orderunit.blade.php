...
@section('ordercode')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <a href="{{ route('setup.createorderunit') }}" class="btn btn-primary mb-3 mt-0"><i
                            class="fas fa-plus"></i>
                        Add</a>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Order Unit</h3>
                            ...
                            <table id="machine" class="table table-head-fixed text-nowrap">
                                ...
                                <tbody>
                                    @php
                                        ...
                                        $orderunit = \App\Models\OrderUnit::get();
                                    @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="" data-toggle="modal"
                                                    data-target="#modal-hapus{{ $ot->id }}"
                                                    class="btn-xs btn-danger"><i class="fas fa-trash-alt"></i>
                                                    Hapus</a>
                                            </td>
                                        </tr>
                                        <div class="modal fade" id="modal-hapus{{ $ot->id }}">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Confirm Delete Order Unit</h4>
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                        <form
                                                            action="{{ route('setup.deleteorderunit', ['id' => $ot->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
