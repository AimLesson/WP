...
@section('content')
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Add KBLI Code</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ route('setup.storekblicode') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="col-md-6">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Add KBLI Code Form</h3>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="exampleInputKBLICode">KBLI Code</label>
                                        <input type="text" name="kbli_code" class="form-control"
                                            id="exampleInputKBLICode" placeholder="Insert KBLI Code" required>
                                        @error('kbli_code')
